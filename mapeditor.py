...
class Game:
    ...
    def handle_mouse_button_down_event(self, event):
        ...
        if self.selected_group_objects:
                self.dragging_group_objects = self.selected_group_objects
                x, y = pygame.mouse.get_pos()
                self.dragging_start_pos = [(x, y) for _ in self.dragging_group_objects]     
    ...
    def set_dragging_objects(self, clones, x, y):
        ...
        else:  # clones é um único objeto
            self.dragging_start_pos = [(x, y)]
